...
contract MemeSoulNFTTest is Test {
    ...
    function test_RevertWhen_MintToZeroAddress() public {
        ...
        vm.prank(owner);
        vm.expectRevert(MemeSoulNFT.InvalidAddress.selector);
    ...
    function test_RevertWhen_MintDuplicateMemeToken() public {
        ...
        vm.expectRevert(MemeSoulNFT.TokenAlreadyLinked.selector);
    ...
    function test_RevertWhen_UnauthorizedUpdateTokenURI() public {
        ...
        vm.prank(user1);
        vm.expectRevert(MemeSoulNFT.UnauthorizedCaller.selector);
        soulNFT.updateTokenURI(tokenId, "ipfs://QmNewNFT");
    }
