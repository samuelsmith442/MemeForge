...
contract MintMemecoin is Script {
    ...
    function run() external {
        ...
        address implementationAddress = getEnvAddressOrDefault("IMPLEMENTATION_ADDRESS", DEFAULT_IMPLEMENTATION_ADDRESS);
        ...
        mintMemecoinSoulNFT(soulNFTAddress, memeTokenAddress, registryAddress, implementationAddress, deployerKey);
    }
    ...
    function mintMemecoinSoulNFT(
        ...
        // Mint the Soul NFT
        uint256 tokenId = soulNFT.mintSoulNFT(recipient, memeTokenAddress, metadata, "ipfs://QmSoulNFTMetadata");
        ...
        address tbaAddress =
            registry.createAccount(implementationAddress, bytes32(0), block.chainid, soulNFTAddress, tokenId);
    ...
    function getEnvAddressOrDefault(string memory envVar, address defaultAddress) internal view returns (address) {
